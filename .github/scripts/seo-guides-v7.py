...
def seo_guides() -> list[dict]:
    pages = [
        ...
        ("concrete-walkway-calculator-guide","How to Calculate Concrete for a Walkway","Concrete & Masonry","concrete","concrete-calculator","Estimate walkway concrete from length, width, thickness and separate sections.","Measure each walkway section, calculate volume in cubic feet, convert to cubic yards and keep allowance visible."),
