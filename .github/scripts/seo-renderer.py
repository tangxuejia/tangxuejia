...
def _interactive_tool(page: dict, base: str) -> str:
    slug = page.get("slug", "")
    flooring = {"flooring-cost-calculator", "laminate-flooring-calculator", "vinyl-flooring-calculator", "hardwood-flooring-calculator", "carpet-calculator", "room-flooring-calculator", "flooring-box-calculator", "bathroom-tile-calculator", "kitchen-tile-calculator"}
