...
if home.exists():
    ...
    planner_links = [("room-renovation-planner", "Room Renovation Planner", "Flooring, paint, baseboard and a starter budget in one plan."), ("bathroom-renovation-planner", "Bathroom Renovation Planner", "Floor tile, wall tile, grout and material planning."), ("concrete-project-planner", "Concrete Project Planner", "Concrete, gravel base, rebar and budget planning."), ("deck-project-planner", "Deck Project Planner", "Deck boards, joists, screws, waste and budget planning.")]
