...
core_profiles = {
    ...
    "tile": ("Tile quantity planning for floors, walls and backsplashes.", "Measured areas, tile face size, layout pattern, openings, waste and carton coverage.", "Net area, planned area, pieces and complete boxes.", "Confirm lot consistency, layout direction, trim, movement joints and the supplier carton label."),
    "bathroom-tile-calculator": ("Bathroom tile takeoff before ordering tile and trim.", "Wall and floor areas, openings, tile size, niche or feature areas and layout waste.", "Planned tile coverage and package quantities by surface.", "Wet-area waterproofing, slope, trim and the installation system are separate checks."),
    "kitchen-tile-calculator": ("Kitchen backsplash and floor tile purchase planning.", "Backsplash runs, wall height, counters or openings, tile size and layout waste.", "Tile area, pieces or boxes and a visible allowance.", "Measure around outlets, windows and cabinets; confirm trim and the actual carton coverage."),
    "flooring-box-calculator": ("Complete-carton flooring quantity for rooms and small projects.", "Each room area, exclusions, plank or tile coverage per carton and waste.", "Net area, planned purchase area and rounded cartons.", "Direction changes, stairs, closets, pattern matching and return limits can change the order."),
    "flooring-cost-calculator": ("Early flooring budget with material and installation costs separated.", "Purchase area, carton price, labor rate, removal, transitions, delivery and contingency.", "Material, labor, preparation and total planning ranges.", "Use local quotes for installation and include subfloor repair, disposal and minimum charges."),
    "cement-calculator": ("Cement and aggregate quantity planning for a specified mix.", "Required volume, mix ratio, bag size, waste and the selected product data.", "Estimated cement, sand and aggregate quantities.", "A ratio is not a structural mix design; confirm strength, local specification and product instructions."),
    "cmu-mortar-calculator": ("Mortar quantity for a concrete masonry unit wall.", "Wall dimensions, block size, joint assumptions, openings, waste and product yield.", "Estimated mortar volume and complete bags or batches.", "Block profile, joint size, reinforcement, grout cells and the selected mortar system affect the final quantity."),
    "sand-calculator": ("Bulk sand volume and weight for beds, fill and landscape work.", "Length, width, placed depth, density, waste and delivery basis.", "Cubic yards, cubic feet, estimated weight and order planning.", "Moisture, compaction, grade, supplier density and delivery minimums are not universal."),
    "paver-base-calculator": ("Paver base material for a patio, walkway or driveway.", "Area, base depth, edge geometry, compaction allowance, density and delivery unit.", "Base volume, estimated weight and purchase quantity.", "Base depth depends on soil, drainage and use; follow the installation system and local requirements."),
    "topsoil-calculator": ("Topsoil quantity for beds, lawns and grading work.", "Area, target depth, exclusions, settling allowance, density and delivery unit.", "Cubic yards, cubic feet and estimated tons.", "Topsoil composition, moisture, settling, access and supplier load size affect the final order."),
    "soil-calculator": ("Soil volume for garden beds and landscape areas.", "Bed length, width, depth, exclusions, settling allowance and bag or bulk coverage.", "Volume plus bags, cubic feet or cubic yards.", "Different plants need different depths and soil blends; verify drainage and the supplier's stated volume."),
    "asphalt-calculator": ("Asphalt tonnage for a driveway, path or patch.", "Surface area, compacted thickness, density, waste and delivery unit.", "Cubic volume, estimated tons and a practical order range.", "Compaction, temperature, mix density, base condition and supplier minimums require confirmation."),
    "roof-area-calculator": ("Roof surface area and material planning from measured roof planes.", "Plan dimensions, pitch or rise/run, waste and accessory scope.", "Sloped area, roofing squares and a starting material quantity.", "Hips, valleys, dormers, penetrations, flashing, starter and ridge materials need separate measurements."),
    "shingle-calculator": ("Roofing shingle bundles and squares for a defined roof area.", "Roof planes, pitch, waste and the selected bundle coverage.", "Roofing squares and rounded field-shingle bundles.", "Bundle coverage varies; add starter, ridge, valley, flashing and underlayment separately."),
    "deck-board-calculator": ("Deck board count and linear footage for a deck field.", "Deck dimensions, board width, gap, stock length, borders and waste.", "Rows, linear footage and a board purchase starting point.", "Picture framing, stairs, diagonal layouts, joists, fasteners and damaged boards need separate quantities."),
    "fence-post-calculator": ("Fence posts and sections for a measured fence run.", "Total run, gate openings, post spacing, corners, ends and gate posts.", "Preliminary section and post count.", "Wind, soil, footing depth, gate loads and local requirements can change the post design."),
    "electrical-load-calculator": ("Preliminary connected-load and demand planning for circuits.", "Appliance watts or amps, voltage, continuous loads and operating assumptions.", "Connected load, estimated current and a planning comparison.", "Do not use this as a final code calculation; circuit, conductor, breaker and service sizing require qualified review."),
    "generator-size-calculator": ("Generator size screening for selected household loads.", "Running watts, starting watts, simultaneous loads and generator efficiency assumptions.", "Estimated running and surge demand with a size range.", "Motor starting behavior, transfer equipment, fuel, ventilation and licensed installation still need review."),
    "hvac-btu-calculator": ("Early HVAC BTU screening for a room or small zone.", "Room dimensions, climate assumption, insulation, windows, occupancy and heat sources.", "A preliminary cooling or heating load range.", "This is not a Manual J replacement; equipment sizing, duct design and local climate data require professional calculation."),
    "insulation-calculator": ("Insulation area and package quantity for walls, ceilings and floors.", "Surface area, openings, target R-value, batt or roll coverage and waste.", "Net area, planned area and rounded packages.", "Assembly, moisture, air sealing, thermal bridges and the product label determine the installed performance."),
    "window-cost-calculator": ("Early window replacement budget by opening count and scope.", "Window sizes, quantity, product price, labor, trim, disposal and contingency.", "Material, labor and visible planning-cost ranges.", "Installation method, structural opening condition, permits, flashing and local quotes can dominate cost."),
    "concrete-patio-calculator": ("Concrete quantity for a patio slab or section.", "Patio length, width, thickness, thickened edges, waste and supplier unit.", "Raw volume, cubic yards or meters and order planning.", "Subgrade, drainage, joints, reinforcement, access and finishing capacity are separate checks."),
    "concrete-footing-calculator": ("Concrete volume for strip, pad or post footings.", "Footing geometry, number of pads or posts, depth, width, length and waste.", "Concrete volume and order quantity by footing type.", "Footing size, reinforcement, soil, frost depth and structural requirements must be confirmed."),
    "concrete-pad-calculator": ("Concrete quantity for a small equipment, shed or utility pad.", "Pad length, width, thickness, thickened areas and waste.", "Cubic volume and a rounded order estimate.", "Base preparation, drainage, anchors, reinforcement and load requirements are not determined by volume alone."),
    "cubic-yard-calculator": ("Cubic-yard conversion for concrete, soil, gravel and mulch.", "Measured length, width, depth, unit system, density or product coverage.", "Cubic feet, cubic yards, cubic meters and optional weight.", "Weight depends on material density and moisture; use supplier data for delivery and tonnage."),
}
...
for src in list(calc_dir.glob("*.html")):
    ...
    if 'id="calc-results"' in text and 'id="reno-legacy-checklist"' not in text:
        legacy_checklist = """<div id="reno-legacy-checklist" class="article" style="margin:16px 0;background:#fff8e8;border-left:4px solid #d99b2b"><h2>Before you order</h2><div class="grid"><label><input type="checkbox"> Re-check the measured dimensions</label><label><input type="checkbox"> Confirm product yield or package coverage</label><label><input type="checkbox"> Confirm waste and whole-package rounding</label><label><input type="checkbox"> Confirm delivery, tax and supplier fees</label><label><input type="checkbox"> Check local code or professional requirements</label></div><p class="note">Use the result card above to copy, print or share the estimate, then verify the final order with the product label or supplier quote.</p></div>"""
        text = re.sub(r'(<aside\b[^>]*id="calc-results"[^>]*>.*?</aside>)', r'\1' + legacy_checklist, text, count=1, flags=re.S | re.I)
    text = text.replace(f'href="{BASE}/#calculators"', f'href="{BASE}/calculators"')
    text = text.replace(f"href='{BASE}/#calculators'", f"href='{BASE}/calculators'")
...
question_links = [
    ("deck-mud-calculator", "How many bags of deck mud do I need?"),
    ("marble-quantity-calculator", "How do I calculate marble quantity?"),
    ("self-leveling-calculator", "How many bags of self-leveling do I need?"),
    ("floor-mud-calculator", "How much floor mud do I need?"),
    ("tuckpointing-calculator", "How much mortar for tuckpointing?"),
    ("concrete-screed-calculator", "How much concrete for a screed?"),
]
question_cards = "".join(f'<a class="pill" href="{BASE}/calculators/{slug}">{html.escape(label)}</a>' for slug, label in question_links)
calculators_index = OUT / "calculators" / "index.html"
calculators_index.write_text(f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Construction Calculators with Clear Buying Answers | RenoMetric</title><meta name="description" content="Find a calculator that gives you the quantity, purchase amount, assumptions and next checks for concrete, flooring, paint, roofing, landscaping and renovation projects."><link rel="canonical" href="{ORIGIN}/calculators"><meta name="robots" content="index,follow"><link rel="stylesheet" href="{BASE}/assets/styles.css"><script type="application/ld+json">{json.dumps(calculator_schema, separators=(",", ":"))}</script></head><body><header class="nav"><div class="wrap nav-in"><a class="brand" href="{BASE}/">Reno<span>Metric</span></a><nav class="nav-links"><a href="{BASE}/calculators">Calculators</a><a href="{BASE}/guides/">Guides</a><a href="{BASE}/methodology.html">Methodology</a></nav></div></header><main><section class="hero"><div class="wrap"><span class="eyebrow">RenoMetric tools</span><h1>Find the right calculator. Know what to buy.</h1><p>Enter measured dimensions and get a clear quantity, purchase amount, visible assumptions and practical checks before you order materials.</p></div></section><section class="section"><div class="wrap"><article class="article" style="background:#eef4f0;border:1px solid #cfe2d7;border-radius:12px"><h2>Start with the question you need to answer</h2><p>These are common planning questions from real searches. Open the closest tool, enter your measurements and check the buying assumptions before ordering.</p><div class="pill-row">{question_cards}</div></article><article class="article" style="margin:24px 0;background:#fff8e8;border:1px solid #ead9a8;border-radius:12px"><span class="tag">Choose the right tool</span><h2>Deck mud, floor mud, self-leveling or concrete screed?</h2><p>These searches can sound similar, but they solve different buying problems. Choose the tool that matches the material and installation system.</p><div class="grid"><div><h3>Deck mud calculator</h3><p>Use for dry-pack mortar beds, shower pans and sloped tile bases. Enter area, average bed depth and labeled bag yield.</p><a href="{BASE}/calculators/deck-mud-calculator">Calculate deck mud bags →</a></div><div><h3>Floor mud calculator</h3><p>Use for tile beds and shower floors when the mortar-bed thickness or slope is the planning question.</p><a href="{BASE}/calculators/floor-mud-calculator">Calculate floor mud →</a></div><div><h3>Self-leveling calculator</h3><p>Use for approved underlayment over an uneven subfloor. Check primer, depth limits and the product yield per bag.</p><a href="{BASE}/calculators/self-leveling-calculator">Calculate self-leveling bags →</a></div><div><h3>Concrete screed calculator</h3><p>Use for a concrete slab or pour that will be struck off with a screed. Screeding changes finishing, not the geometric volume.</p><a href="{BASE}/calculators/concrete-screed-calculator">Calculate concrete for a screed →</a></div></div><p class="note"><b>Do not substitute materials:</b> these tools estimate quantities from measurements; the selected product, substrate, slope, reinforcement and local requirements control the final installation.</p></article><div class="grid">{"".join(calculator_cards)}</div><article class="article"><h2>How to use the calculator library</h2><p>Start with the project closest to your work, use consistent units, replace generic coverage or density assumptions with the product data, and keep the result as a planning estimate until site conditions and supplier requirements are confirmed.</p><p class="note"><b>Planning only:</b> final quantities can change with measurements, waste, product specifications, installation method and local requirements.</p></article></div></section></main><footer class="footer"><div class="wrap"><p class="legal">© 2026 RenoMetric. Transparent home-improvement planning tools and guides.</p></div></footer></body></html>''', encoding="utf-8")
