...
;(() => { if (!document.getElementById("project-workspace")) { const script = document.createElement("script"); script.src = "/assets/workspace.js"; script.defer = true; document.head.appendChild(script); } })();
